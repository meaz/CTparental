...
echo "</td></tr>";
	...
	echo "<CENTER><H3>".gettext('WhiteList Filtering')."</H3></CENTER>";
	...
	echo "<center>".gettext('Choice of authorized categories')."</center></td></tr>";
	...
	echo "<H3>".gettext('Rehabilitated domain names')."</H3>".gettext('2-Enter the domain names permitted in addition to the white list of Toulouse.')."<BR>".gettext('Enter one domain name per row (example : .domain.org)')."<BR>";
